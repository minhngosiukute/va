let messages = ["M chọn ko chứ gì , chọn có cho t ", "Give me a chance!", "Are you sure?", "Think again!", "You might regret this!", "One last chance!", "Pretty please?", "Don’t break my heart 💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">We are bitches❤️moahmoah....</div>
    `;
    launchConfetti();
    startHeartRain();
}
